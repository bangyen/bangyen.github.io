                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Box sx={{ marginBottom: 2 }}>
                                <Typography
                                    ...
                                    sx={{ marginBottom: 1 }}
                                >
                                    Gradient Filtering Percentile: {percentile}%
                                </Typography>
                                <Slider
                                    value={percentile}
                                    onChange={(e, value) =>
                            ...
                            <Box>
                                ...
                                <Slider
                                    value={momentum}
                                    onChange={(e, value) => setMomentum(value)}
                                    min={0.5}
                                    max={0.99}
                                    step={0.01}
                                    disabled={isRunning}
                ...
                <Grid item xs={12} md={6}>
                    ...
                    >
                        <CardContent>
                            ...
                            <Box sx={{ height: 300 }}>
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={gradientData.slice(0, 20)}>
                                        <CartesianGrid
                                            strokeDasharray="3 3"
                                            stroke="rgba(255,255,255,0.1)"
                                        />
                    ...
                    >
                        <CardContent>
                            ...
                            <Box sx={{ marginBottom: 2 }}>
                                ...
                                >
                                    Keep only gradients above the {percentile}th

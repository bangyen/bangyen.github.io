...
import { MenuRounded, GitHub } from '@mui/icons-material';

import { Typography, Divider, Box, Menu, MenuItem } from '@mui/material';
...
function WaveBox({ index, count, height, width }) {
    const duration = 1;

...
/**
 * Raw data point from the ZSharp experiment dataset, containing both
 * accuracy and loss metrics for SGD and ZSharp optimisers.
 */
...
/**
 * Fetches and normalises the gzipped ZSharp experiment JSON into an
 * array of per-epoch data points for charting.
 */
export const loadRealZSharpData = async (): Promise<DataPoint[]> => {
...
/**
 * Predefined view types for the ZSharp research demo, covering accuracy,
 * loss, learning-curve gap, and convergence-rate perspectives.  Defined
 * at module scope so they are created once and shared across renders.
 */
export const zsharpViewTypes: ViewType<DataPoint>[] = [
    {
        key: 'accuracy',
        label: 'Accuracy',
    ...
    },
    {
        ...
        chartConfig: {
            ...
            yAxisDomain: buildAxisDomain(RESEARCH_CONSTANTS.zsharp.lossPadding),
    ...
    },
    {
        ...
        chartConfig: {
            ...baseChart,
            yAxisFormatter: pctFormatter(1),
            yAxisDomain: buildAxisDomain(RESEARCH_CONSTANTS.zsharp.gapPadding),

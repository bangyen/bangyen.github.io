...
describe('SlantAnalysisBoard', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });

    it('renders the grid correctly', () => {
        render(<SlantAnalysisBoard {...DEFAULT_PROPS} />);
    ...
    it('handles click interactions', () => {
        ...
        const { container } = render(
            <SlantAnalysisBoard {...DEFAULT_PROPS} onMove={onMove} />,
        );
    ...
    it('displays empty state for missing numbers', async () => {
        ...
        const { container } = render(
            <SlantAnalysisBoard {...DEFAULT_PROPS} numbers={numbers} />,
        );
    ...
    it('handles both desktop and mobile padding variants', () => {
        const { container } = render(<SlantAnalysisBoard {...DEFAULT_PROPS} />);
